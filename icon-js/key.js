 ...
 */
function privateKeyFromKeyStoreObj(keyStoreObj, password) {
    let derivedKey;
...
function toKeyStoreObj(privateKey, address, password, options) {
...
/**
 * Provide key ICON wallet module for javascript
 * @module icon-js/key
*/
module.exports = {
    ...
    privateKeyFromKeyStoreObj : privateKeyFromKeyStoreObj,
    toKeyStoreObj : toKeyStoreObj
};